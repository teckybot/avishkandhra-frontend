...
const Navbar = () => {
    ...
    const navItems = [
        { name: 'Home', id: 'home' },
        { name: 'Certificate (Recognition)', id: 'certificate' },
    ...
    return (
        <nav
            className="w-full bg-white px-6 py-4 shadow-sm fixed top-0 z-50"
        ...
        >
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                    <img src={logo} alt="Logo" className="w-30 h-16 md:ml-12 sm:ml-3" />
                </div>
                ...
                <div className="hidden md:flex space-x-12 mr-36 gap-10">
                    {navItems.map((item) => (
                        <button
                            ...
                            className="font-semibold text-[20px] font-['Segoe_UI'] text-black hover:text-orange-500 transition"
                        >
                            {item.name}
                        </button>
                    ))}
